...
#SBATCH -o /scratch/akb/final_experiments/out_files/naive/sgd-naive_hard-%j.out
...
SEED=10
python cont_ER.py \
       --save_dir /scratch/${USER}/final_experiments/naive/batch/${OPTIM_NAME}_naive_hard_${SEED} \
