...
#SBATCH -o /scratch/akb/final_experiments/out_files/mtl/sgd-mtl_easy-%j.out
...
python cont_multitask.py \
       --save_dir /scratch/${USER}/final_experiments/MTL/batch/${OPTIM_NAME}_MTL_easy_${SEED} \
