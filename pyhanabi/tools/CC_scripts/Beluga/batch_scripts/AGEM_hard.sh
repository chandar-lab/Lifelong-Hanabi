...
#SBATCH -o /scratch/akb/final_experiments/out_files/agem/sgd-agem_hard-%j.out
...
SEED=10
python cont_AGEM.py \
       --save_dir /scratch/${USER}/final_experiments/AGEM/batch/${OPTIM_NAME}_AGEM_hard_${SEED} \
