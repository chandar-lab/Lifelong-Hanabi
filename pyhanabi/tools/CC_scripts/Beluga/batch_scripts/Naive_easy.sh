...
#SBATCH -o /scratch/akb/final_experiments/out_files/naive/sgd-naive_easy-%j.out
...
SEED=10
python cont_ER.py \
       --save_dir /scratch/${USER}/final_experiments/naive/batch/${OPTIM_NAME}_naive_easy_${SEED} \
