...
#SBATCH -o /scratch/akb/final_experiments/out_files/ewc/sgd-ewc_offline_easy-%j.out
...
SEED=10
python cont_EWC.py \
       --save_dir /scratch/${USER}/final_experiments/EWC/batch/${OPTIM_NAME}_EWC_offline_easy_${SEED} \
