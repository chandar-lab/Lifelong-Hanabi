...
#SBATCH -o /scratch/akb/final_experiments/out_files/naive/cont_eval/sgd_naive_hard-cont-eval-%j.out
...
python continual_evaluation.py \
       --weight_1_dir /scratch/${USER}/final_experiments/naive/batch/${OPTIM_NAME}_naive_hard_${SEED} \
