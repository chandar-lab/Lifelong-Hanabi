...
#SBATCH -o /scratch/akb/final_experiments/out_files/er/cont_eval/sgd_er_hard-cont-eval-%j.out
...
python continual_evaluation.py \
       --weight_1_dir /scratch/${USER}/final_experiments/ER/batch/${OPTIM_NAME}_ER_hard_${SEED} \
