...
#SBATCH -o /scratch/akb/final_experiments/out_files/mtl/cont_eval/sgd_mtl_hard-cont-eval-%j.out

USER="akb"
LOAD_MODEL_DIR="/scratch/akb/final_experiments/final_model_pool_for_csv"
OPTIM_NAME="SGD"
python continual_evaluation.py \
       --weight_1_dir /scratch/${USER}/final_experiments/MTL/batch/${OPTIM_NAME}_MTL_hard \
