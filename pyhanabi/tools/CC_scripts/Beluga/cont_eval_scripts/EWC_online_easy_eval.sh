...
#SBATCH -o /scratch/akb/final_experiments/out_files/ewc/cont_eval/sgd_ewc_online_easy-cont-eval-%j.out
...
python continual_evaluation.py \
       --weight_1_dir /scratch/${USER}/final_experiments/EWC/batch/${OPTIM_NAME}_EWC_online_easy_${SEED} \
