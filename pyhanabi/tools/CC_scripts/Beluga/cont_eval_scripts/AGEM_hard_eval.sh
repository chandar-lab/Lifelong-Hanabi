...
#SBATCH -o /scratch/akb/final_experiments/out_files/agem/cont_eval/sgd_agem_hard-cont-eval-%j.out
...
python continual_evaluation.py \
       --weight_1_dir /scratch/${USER}/final_experiments/AGEM/batch/${OPTIM_NAME}_AGEM_hard_${SEED} \
