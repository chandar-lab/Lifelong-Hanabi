...
#SBATCH -o /scratch/akb/final_experiments/out_files/mtl/cont_eval/sgd_mtl_easy-cont-eval-%j.out
...
python continual_evaluation.py \
       --weight_1_dir /scratch/${USER}/final_experiments/MTL/batch/${OPTIM_NAME}_MTL_easy_${SEED} \
