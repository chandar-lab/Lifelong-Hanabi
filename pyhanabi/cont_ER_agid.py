...
## this is the learnable agent.
    ...
    for task_idx, fixed_agent in enumerate(fixed_agents):
        ...
        learnable_agent.agent_id = agent_ids[task_idx]
        print("learnable agent agent id before ActGroup is ", learnable_agent.agent_id)
        act_group = ActGroup(
            args.method,
            args.act_device,
            ...
            if (epoch+1) % args.eval_freq == 0:
                ...
                for eval_fixed_ag_idx, eval_fixed_agent in enumerate(fixed_agents + [fixed_learnable_agent]):
                    ...
                    if args.eval_method == 'few_shot':
                        ...
                        few_shot_learnable_agent.agent_id = agent_ids[eval_fixed_ag_idx]
                        print("few shot learnable agent id before ActGroup is ", few_shot_learnable_agent.agent_id)
