...
class R2D2Net(torch.jit.ScriptModule):
    __constants__ = ["hid_dim", "in_id_dim", "out_dim", "num_fflayer", "num_agid_layers", "num_rnn_layer", "hand_size"]

    def __init__(self, device, in_dim, in_id_dim, hid_dim, out_dim, num_fflayer, num_agid_layers, num_rnn_layer, hand_size):
        super().__init__()
        self.in_dim = in_dim
        self.in_id_dim = in_id_dim
